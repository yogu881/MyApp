    ...
    return (
        <>
            <div className='container'>
                        ...
                        return (
                            <><tbody>
                                <tr>
                                    ...
                                    <td>
                                        <button type="button" class="btn btn-outline-secondary" data-bs-toggle="modal" data-bs-target="#exampleModal" onClick={() => {
                                            ucn(val);
                                        }}>
                                            update
                                        </button>
                                                ...
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body">
                                                        <form action="" onSubmit={submits}>
                                                            ...
                                                            <center><button className="btn btn-outline-success" data-bs-dismiss="modal">Update Product</button></center>
                                                        </form>
                                                    </div>
                ...
                }} /> <button className='btn btn-outline-warning' onClick={display}>Search</button></center>
